 ...
 * by utlizing the String.join() method to create each line of the banner. This approach 
...
// Extend use case UC2 to the String.join() method to create each line of the "OOPS" banner 
